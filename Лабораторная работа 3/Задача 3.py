...
def count_letters(text):
    ...
    letter_count = {}
    for char in text:
        # Учитываем только буквы (можно добавить проверку на регистр, если нужно)
        if char.isalpha():
            char = char.lower()  # Приводим к нижнему регистру для учета частоты
